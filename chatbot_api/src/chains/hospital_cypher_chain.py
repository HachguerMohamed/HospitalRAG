...
Use aggregating functions if needed such as (AVG(),SUM(),COUNT())
...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    cypher_llm=ChatGoogleGenerativeAI(model=HOSPITAL_CYPHER_MODEL, convert_system_message_to_human=True, temperature=0),
    qa_llm=ChatGoogleGenerativeAI(model=HOSPITAL_QA_MODEL, convert_system_message_to_human=True, temperature=0),
    graph=graph,
    verbose=True,
